...
const NavBar = () => {
  ...
  // 3. Efek untuk menerapkan tema ke elemen HTML
  useEffect(() => {
    localStorage.setItem("theme", theme);
    const localTheme = localStorage.getItem("theme");
    // Gunakan 'data-theme' untuk DaisyUI, atau classList.add('dark') untuk Tailwind murni
  ...
  return (
    <div
      className={`sticky top-0 ${
        position > 50
          ? "bg-base-100 border-b border-gray-300" // Menggunakan warna dinamis bg-base-100 DaisyUI
      ...
      <div className="navbar flex justify-between mx-auto content">
        <div className="flex items-center justify-between">
          <div className="dropdown">
            ...
            <ul
              tabIndex={0}
              className={`menu menu-lg dropdown-content rounded-box z-1 mt-3 w-lvw p-2 shadow font-semibold flex-nowrap bg-base-100`}
            >
              {menu}
            </ul>
          </div>
        ...
        <div className="lg:flex items-center gap-4">
          ...
          {/* 4. Tombol Toggle Dark/Light Mode */}
