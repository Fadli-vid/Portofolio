...
const Profile = () => {
  return (
    <div
      ...
      className={`relative mx-4 xxl:mx-0.5 -bottom-20 lg:-bottom-28 z-10 rounded-2xl bg-base-100 drop-shadow-2xl shadow-black/5 dark:shadow-white/5 max-xl:mb-5 xl:p-28 lg:p-20 md:p-16 p-6 sm:p-10 transition-colors duration-300`}
      id="profile"
    >
      <div className="flex max-md:flex-col justify-between items-center gap-6">
        ...
        <div className="w-full max-w-[33rem] text-base-content">
          <h2
            className={`text-3xl sm:text-4xl lg:text-[38px] max-md:text-center font-semibold mb-8`}
          >
            I am Junior User Interface Designer
          </h2>
          <div
            // Hapus text-gray-600, gunakan opacity agar di mode light/dark tetap serasi
            className={`text-base lg:text-lg font-normal max-md:text-center opacity-80`}
          >
            <p className={``}>
          ...
          <div className="mt-8 flex max-md:justify-center">
            <a
              className="btn min-w-[140px] px-6 py-3 btn-primary text-[14px] sm:text-[16px]"
              href="#!"
            >
              My Projects
            </a>
