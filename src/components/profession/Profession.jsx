...
const Profession = () => {
  return (
    <div
      className="content grid md:grid-cols-2 max-xxl:px-4 xxl:px-2 py-10 md:py-15 lg:py-37.5 transition-colors duration-300"
      id="services"
    >
      <div className="flex flex-col justify-between h-fit md:pe-8 lg:pe-35.75 max-md:text-center my-auto text-base-content">
        <p className="section-title max-md:text-center">What I do?</p>
        <div className="mt-6">
          <p className="text-xs sm:text-lg font-normal opacity-70 mb-4">
          ...
          <p className="text-xs sm:text-lg font-normal opacity-70">
